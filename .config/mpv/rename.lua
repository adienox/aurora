-- script from https://github.com/Kayizoku/mpv-rename/blob/main/Rename.lua
...
local function rename(text, error)
	...
	local newfilepath = utils.join_path(directory, text)
...
mp.add_key_binding("Ctrl+r", "rename-file", function()
